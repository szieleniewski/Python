...
def gauss_convolve(SED, sigma, lambda_space='Linear'):
    ...
    #Interpolate SED
    interspec = si.interp1d(SED[:,0], SED[:,1], kind='linear')
    ...
    if lambda_space=='Linear':
        ...
        gauss_array = Gauss1D(sigma, (lin_lambs[1]-lin_lambs[0]))
        ...
        #Create normalised Gaussian
        gauss_array = Gauss1D(sigma, (log_lambs[1]-log_lambs[0]))
        #Convolve
        ...
        interspec2 = si.interp1d(lambs, conv_ys, kind='linear')
